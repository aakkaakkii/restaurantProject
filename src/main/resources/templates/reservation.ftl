    ...
    <#--        navbar ends here-->
        ...
        <div class="container mb-5 py-2">
            <div class="row">
                ...
                <div class="col-md-8 mt-5 d-flex justify-content-center order-md-0 order-1">
...
<#--        </div>-->
    ...
    <#if section = "scripts">
        <script src="https://booking-widget.quandoo.com/index.js" data-merchant-id="63457" data-theme="dark"></script>
        <script>
